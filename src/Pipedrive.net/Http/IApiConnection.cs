...
namespace Pipedrive
{
    ...
    public interface IApiConnection
    {
        ...
        /// <returns><see cref="IReadOnlyList{T}"/> of the The API resources in the list.</returns>
        /// <exception cref="ApiException">Thrown when an API error occurs.</exception>
        Task<IReadOnlyList<T>> SearchAll<T>(Uri uri);
        ...
        /// <returns><see cref="IReadOnlyList{T}"/> of the The API resources in the list.</returns>
        /// <exception cref="ApiException">Thrown when an API error occurs.</exception>
        Task<IReadOnlyList<T>> SearchAll<T>(Uri uri, ApiOptions options);
        ...
        /// <returns><see cref="IReadOnlyList{T}"/> of the The API resources in the list.</returns>
        /// <exception cref="ApiException">Thrown when an API error occurs.</exception>
        Task<IReadOnlyList<T>> SearchAll<T>(Uri uri, IDictionary<string, string> parameters);
        ...
        /// <returns><see cref="IReadOnlyList{T}"/> of the The API resources in the list.</returns>
        /// <exception cref="ApiException">Thrown when an API error occurs.</exception>
        Task<IReadOnlyList<T>> SearchAll<T>(Uri uri, string accepts);
        ...
        /// <returns><see cref="IReadOnlyList{T}"/> of the The API resources in the list.</returns>
        /// <exception cref="ApiException">Thrown when an API error occurs.</exception>
        Task<IReadOnlyList<T>> SearchAll<T>(Uri uri, IDictionary<string, string> parameters, ApiOptions options);
        ...
        /// <returns><see cref="IReadOnlyList{T}"/> of the The API resources in the list.</returns>
        /// <exception cref="ApiException">Thrown when an API error occurs.</exception>
        Task<IReadOnlyList<T>> SearchAll<T>(Uri uri, IDictionary<string, string> parameters, string accepts);
        ...
        /// <returns><see cref="IReadOnlyList{T}"/> of the The API resources in the list.</returns>
        /// <exception cref="ApiException">Thrown when an API error occurs.</exception>
        Task<IReadOnlyList<T>> SearchAll<T>(Uri uri, IDictionary<string, string> parameters, string accepts, ApiOptions options);
        ...
        /// <summary>
        /// Updates the API resource at the specified URI using HTTP PATCH.
        /// </summary>
        /// <typeparam name="T">The API resource's type.</typeparam>
